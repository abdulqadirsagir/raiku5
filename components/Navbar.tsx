...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed w-full z-50 bg-raiku-dark/80 backdrop-blur-md border-b border-white/10">
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="md:hidden bg-raiku-card border-b border-white/10">
